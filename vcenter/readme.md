...
3. **스토리지 요약** — 공유 데이터스토어(로컬 제외) 용량/사용량/잔여량, 호스트별 데이터스토어 Latency·Throughput·IOPS(각각 Total/Read/Write)
...
| `03_HostDatastorePerf_*.csv` | 호스트별 데이터스토어 성능(Latency/Throughput/IOPS) |
